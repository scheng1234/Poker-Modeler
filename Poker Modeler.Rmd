...
```
# Hand Picker
A script to identify the hand you have. We'll rely on the Holdem package for dealing, simulation, and other aspects of texas holdem. We'll need to convert between the holdem package and ours
...
**Royal Flush** The same as straight flush so it doesn't need to be coded.

**Residuals** To account for any kickers, since every hand has a max value of 5 cards, there will be cases where there are no kickers
